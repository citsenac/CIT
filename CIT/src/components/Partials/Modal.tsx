export default function Modal({children, toggleModal}: {children: React.ReactNode, toggleModal: () => void}) {
    ...
    return (
       <>
            ...
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 z-50 h-auto w-[95%] bg-gradient-to-b from-[#404042] to-[#303030] rounded-2xl border-2 border-[#989898] pb-4 pt-6 px-4">
